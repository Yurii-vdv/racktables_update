...
// patched for Racktables 0.22.0 by Yurii Yaranin
// 2014-08-20 - Mogilowski Sebastian <sebastian@mogilowski.net>

// http://www.mogilowski.net/projects/racktables
function plugin_cableIDHelper_info ()
{               
        return array
        (       
                'name' => 'cableIDHelper',
                'longname' => 'cableIDHelper', 
                'version' => '0.2.1',
                'home_url' => 'https://github.com/Yurii-vdv'
        );          
}  

function plugin_cableIDHelper_init ()
{
	global $page, $tab;
	$tab['rack']['CableIDs'] = 'Cable IDs';
	$trigger['rack']['CableIDs'] = 'Cable IDs';
	$tabhandler['rack']['CableIDs'] = 'CableIDTabHandler';
	
	
	registerTabHandler('rack','CableIDs','CableIDTabHandler');
}
function plugin_cableIDHelper_install ()
{
	return TRUE;
}

function plugin_cableIDHelper_uninstall ()
{
	return TRUE;
}

function plugin_cableIDHelper_upgrade ()
{
        return TRUE;
}
