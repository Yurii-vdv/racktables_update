...
//		* indentation format
//
function plugin_liveinterfaces_info ()
{               
        return array
        (       
                'name' => 'liveinterfaces',
                'longname' => 'Live interfaces', 
                'version' => '0.1.2',
                'home_url' => 'https://github.com/Yurii-vdv'
        );          
}  

function plugin_liveinterfaces_init ()
{
	global $page, $tab;
	$tab['object']['liveinterfaces'] = 'Live interfaces';
	$trigger['object']['liveinterfaces'] = 'trigger_liveports';
	
	$tabhandler['object']['liveinterfaces'] = 'Live interfaces';
	
	registerTabHandler('object','liveinterfaces','renderInterfacesStats');
}

function plugin_liveinterfaces_install ()
{
	return TRUE;
}

function plugin_liveinterfaces_uninstall ()
{
	return TRUE;
}

function plugin_liveinterfaces_upgrade ()
{
        return TRUE;
}
